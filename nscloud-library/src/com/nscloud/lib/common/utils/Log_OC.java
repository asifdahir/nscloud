package com.nscloud.lib.common.utils;
...
public class Log_OC {
    ...
    private static String mNsCloudDataFolderLog = "nscloud_log";
    ...
    public static void setLogDataFolder(String logFolder){
    	mNsCloudDataFolderLog = logFolder;
    }
    ...
    public static void startLogging() {
    	String logPath = Environment.getExternalStorageDirectory() + File.separator +
                mNsCloudDataFolderLog + File.separator + LOG_FOLDER_NAME;
