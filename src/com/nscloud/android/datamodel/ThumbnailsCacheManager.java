...
package com.nscloud.android.datamodel;
...
import com.nscloud.android.ui.adapter.DiskLruImageCache;
...
public class ThumbnailsCacheManager {
    ...
    private static NsCloudClient mClient = null;
    ...
    public static class ThumbnailGenerationTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            ...
            try {
                if (mAccount != null) {
                    NsCloudAccount ocAccount = new NsCloudAccount(mAccount,
        ...
        private Bitmap doOCFileInBackground() {
            ...
            if (thumbnail == null || file.needsUpdateThumbnail()) {
                ...
                if (file.isDown()) {
                    ...
                    NsCloudVersion serverOCVersion = AccountUtils.getServerVersion(mAccount);
