...
public class MainApp extends Application {
    ...
    public void onCreate() {
        ...
        NsCloudClientManagerFactory.setUserAgent(getUserAgent());
        if (isSamlAuth) {
            NsCloudClientManagerFactory.setDefaultPolicy(Policy.SINGLE_SESSION_PER_ACCOUNT);
        } else {
            NsCloudClientManagerFactory.setDefaultPolicy(Policy.ALWAYS_NEW_CLIENT);
        }
