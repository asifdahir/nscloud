...
import com.nscloud.lib.resources.shares.GetRemoteSharesForFileOperation;
...
public class RefreshFolderOperation extends RemoteOperation {
    ...
    private void updateOCVersion(NsCloudClient client) {
    ...
    private void startContentSynchronizations(
            List<SynchronizeFileOperation> filesToSyncContents, NsCloudClient client
        ) {
    ...
    private RemoteOperationResult refreshSharesForFolder(NsCloudClient client) {
        RemoteOperationResult result = null;
