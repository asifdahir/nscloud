...
package com.nscloud.android.operations.common;
...
public abstract class SyncOperation extends RemoteOperation {
     ...
     * {@link #execute(NsCloudClient, com.nscloud.android.datamodel.FileDataStorageManager)}.
     * 
    ...
    */
	 ...
	 * @return					Thread were the remote operation is executed.
	 */
	public Thread execute(NsCloudClient client, FileDataStorageManager storageManager,
