...
import com.nscloud.lib.resources.status.GetRemoteStatusOperation;
...
public class GetServerInfoOperation extends RemoteOperation {
	...
	protected RemoteOperationResult run(NsCloudClient client) {
        ...
        if (result.isSuccess()) {
            ...
            mResultData.mVersion = (NsCloudVersion)(result.getData().get(0));
    ...
    private RemoteOperationResult detectAuthorizationMethod(NsCloudClient client) {
    ...
    public static class ServerInfo {
        public NsCloudVersion mVersion = null;
