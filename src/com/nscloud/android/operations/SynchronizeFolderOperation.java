...
import com.nscloud.lib.common.operations.OperationCancelledException;
...
import com.nscloud.lib.resources.files.ReadRemoteFolderOperation;
...
public class SynchronizeFolderOperation extends SyncOperation {
    ...
    private RemoteOperationResult checkForChanges(NsCloudClient client)
    ...
    private RemoteOperationResult fetchAndSyncRemoteFolder(NsCloudClient client)
            throws OperationCancelledException {
        if (mCancellationRequested.get()) {
            throw new OperationCancelledException();
        }
     ...
     */
    private void synchronizeData(ArrayList<Object> folderAndFiles, NsCloudClient client)
            throws OperationCancelledException {
        FileDataStorageManager storageManager = getStorageManager();
    ...
    private void syncContents(NsCloudClient client) throws OperationCancelledException {
    ...
    /**
     * Creates and populates a new {@link com.nscloud.android.datamodel.OCFile}
     ...
     * a 'lost' file with the same full name as the {@link com.nscloud.android.datamodel.OCFile}
