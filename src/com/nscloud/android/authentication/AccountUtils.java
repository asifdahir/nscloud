...
public class AccountUtils {
     ...
     */
    public static String getWebdavPath(NsCloudVersion version, String authTokenType) {
        if (version != null) {
        ...
        if ( currentAccount != null ) {
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    newAccountName = com.nscloud.lib.common.accounts.AccountUtils.
     ...
     */
    public static NsCloudVersion getServerVersion(Account account) {
        NsCloudVersion serverVersion = null;
        if (account != null) {
            AccountManager accountMgr = AccountManager.get(MainApp.getAppContext());
            String serverVersionStr = accountMgr.getUserData(account, Constants.KEY_OC_VERSION);
            if (serverVersionStr != null) {
                serverVersion = new NsCloudVersion(serverVersionStr);
            }
        }
