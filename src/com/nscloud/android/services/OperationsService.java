...
package com.nscloud.android.services;
...
import com.nscloud.lib.resources.shares.ShareType;
...
import com.nscloud.android.operations.SynchronizeFolderOperation;
...
public class OperationsService extends Service {
    ...
    public void onDestroy() {
        ...
        // Saving cookies
        try {
            NsCloudClientManagerFactory.getDefaultSingleton().
    ...
    private static class ServiceHandler extends Handler {
        ...
        private NsCloudClient mOwnCloudClient = null;
                ...
                try {
                    ...
                    if (mLastTarget == null || !mLastTarget.equals(next.first)) {
                        ...
                        if (mLastTarget.mAccount != null) {
                            NsCloudAccount ocAccount = new NsCloudAccount(mLastTarget.mAccount,
                                    mService);
                            mOwnCloudClient = NsCloudClientManagerFactory.getDefaultSingleton().
                                    getClientFor(ocAccount, mService);

                            NsCloudVersion version = com.nscloud.android.authentication.AccountUtils.getServerVersion(
                                    mLastTarget.mAccount
                            );
                            mOwnCloudClient.setNsCloudVersion(version);
                            ...
                            if (mLastTarget.mCookie != null &&
                                ...
                                credentials = NsCloudCredentialsFactory.newSamlSsoCredentials(
                                        null,                   // unknown
                                        mLastTarget.mCookie);   // SAML SSO
                            }
                            NsCloudAccount ocAccount = new NsCloudAccount(
